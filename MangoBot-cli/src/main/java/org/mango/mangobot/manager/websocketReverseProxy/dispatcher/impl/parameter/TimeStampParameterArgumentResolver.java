...
import org.mango.mangobot.annotation.QQ.parameter.TimeStamp;
...
@Component
public class TimeStampParameterArgumentResolver implements ParameterArgumentResolver {

    @Override
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasAnnotation(TimeStamp.class);
    }
